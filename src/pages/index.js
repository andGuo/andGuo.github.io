	...
	return (
		<Layout>
			...
			<div className="flex flex-wrap mb-14 h-64 flex-col items-center justify-around sm:my-16 sm:flex-row sm:items-start sm:justify-center">
				...
				<a href="https://github.com/andGuo" target="_blank" rel="noreferrer" className="indexBtn">
				...
				<a href="https://www.linkedin.com/in/-andrewguo/" target="_blank" rel="noreferrer" className="indexBtn">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
