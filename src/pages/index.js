	...
	return (
		<Layout>
			...
			<div className="flex flex-wrap h-64 items-start justify-center">
				...
				<button href="https://github.com/andGuo" target="_blank" rel="noreferrer" className="indexBtn">
				...
				<button href="https://www.linkedin.com/in/-andrewguo/" target="_blank" rel="noreferrer" className="indexBtn">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
