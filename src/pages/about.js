...
export default function about({ data }) {
    const description = data.allMarkdownRemark.edges[0].node.html;
        ...
        <Layout>
            ...
            <div className="lg:my-12 lg:mx-28 lg:px-16 grid lg:grid-cols-4 gap-4 items-start justify-center">
                <div className="ml-6 mr-4 mt-3 mb-1 flex flex-col items-start">
                    ...
                    <img
                        src="https://avatars.githubusercontent.com/u/83620241?v=4"
                        alt="Profile"
                        className="my-3 w-36 h-36 rounded-full object-cover border-4  border-lightPrimary dark:border-darkPrimary"
                    /> 
                ...
                <div className="flex items-center md:h-full col-span-3 text-lightText dark:text-darkText my-4 mx-2 px-4">
                    <span className="py-6">
                        <h1 className="mb-3 text-3xl text-lightPrimary dark:text-darkPrimary text-bold">{title}</h1>
                        <span className="text-lg"><div
                            dangerouslySetInnerHTML={{ __html: description }}
                        /></span> {/*I like to live dangerously :-)*/}
                    </span>
                </div>
                <div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 254.5 225" xmlSpace="preserve">
                            <g>
                                ...
                                <g>
                                    <g>
                                        <g>
                                            <path className="fill-cyan-500" d="M25.1,110.3c-0.4,0-0.5-0.2-0.3-0.5l2.1-2.7c0.2-0.3,0.7-0.5,1.1-0.5l45.6,0c0.4,0,0.6,0.3,0.5,0.6      l-0.8,2.4c-0.1,0.4-0.5,0.6-0.9,0.6L25.1,110.3z"/>
                                        </g>
                                    </g>
                                </g>
                                <g>
                                    <g>
                                        <g>
                                            <path className="fill-cyan-500" d="M49.3,119.5c-0.4,0-0.5-0.3-0.3-0.6l1.4-2.5c0.2-0.3,0.6-0.6,1-0.6l20,0c0.4,0,0.6,0.3,0.6,0.7l-0.2,2.4      c0,0.4-0.4,0.7-0.7,0.7L49.3,119.5z"/>
                                        </g>
                                    </g>
                                </g>
                                <g>
...
query markdownQuery {
    allMarkdownRemark(filter: {frontmatter: {slug: {eq: "about-me-description"}}}) {
      edges {
        node {
          html
          frontmatter {
