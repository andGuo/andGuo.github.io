...
export default function about() {
    return (
        <Layout>
            <Seo title="About Me" />
            <div className="md:my-16 md:mx-28 grid grid-cols-2 gap-4 items-start justify-center">
                <div className="ml-6 mr-4 my-6 flex flex-col items-start">
                    <h2 className="text-2xl my-1">Software Developer</h2>
                    <h1 className="text-4xl my-1">Andrew Guo</h1>
                ...
                <div className="text-lightText dark:text-darkText my-6 mx-2 w-2/3">
