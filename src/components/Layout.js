            ...
            <div className="flex flex-col flex-grow justify-between">
                ...
                <footer className="flex justify-center align-middle content-start">
                    ...
                    <p className="px-1 py-0.5">
                        <span className="text-secondaryLight px-0.5 font-bold">andGuo 2022</span>
                        <span className="font-bold text-lg">|</span>
                        <span className="text-xs px-0.5">Created with
                            <a className="text-secondaryLight hover:text-primaryDark hover:underline px-1" href="https://www.gatsbyjs.com/" target="_blank" rel="noreferrer">Gatsby</a>
                        </span>
                    </p>
                </footer>
            </div>
