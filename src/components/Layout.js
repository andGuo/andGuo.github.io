...
export default function Layout({ children }) {
    return (
        <div className="flex justify-center min-h-screen bg-gradient-to-br from-lightSecondary to-gray-400 text-lightPrimary dark:bg-gradient-to-br dark:from-darkSecondary dark:to-gray-700 dark:text-darkPrimary">
            <div className="flex flex-col grow max-w-7xl">
                ...
                <div className="flex flex-col flex-grow justify-between">
                    ...
                    <footer className="flex justify-center align-middle content-start mt-4 mb-16 auto-cols-auto">
                        <svg className="pt-0.5 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="-10 -5 1034 1034" version="1.1">
                        ...
                        <p className="px-0.5 py-0.5">
                            <a className="text-lightSecondary px-0.5 font-bold hover:text-lightPrimary dark:hover:text-darkPrimary hover:underline" href="https://github.com/andGuo" target="_blank" rel="noreferrer">andGuo 2022</a>
